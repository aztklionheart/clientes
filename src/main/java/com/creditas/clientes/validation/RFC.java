...
public @interface RFC {
	...
	/**
	 * Determines if {@code ""} (empty string) is a valid value. Web forms usually
	 * send <em>empty fields</em>, this flags is intended for these cases.
	 *
	 * @return {@code false} by default, empty string is not a valid value by
	 *         default.
	 */
	boolean isEmptyValueValid() default false;

	/**
	 * Determines if {@code "XAXX010101000"} (general public's RFC) is a valid
	 * value.
	 *
	 * @return {@code false} by default, general public's RFC is not a valid value
	 *         by default.
	 */
	 ...
	 *
	 * @return {@code false} by default, foreign's RFC is not a valid value by
	 *         default.
	 */
	 ...
	 */
	String message() default "{com.creditas.clientes.validation.RFC.message}";
	...
	@interface PalabraInconveniente {
		 ...
		 * @return Default message template string.
		 */
		String message() default "{com.creditas.clientes.validation.RFC.PalabraInconveniente.message}";
	...
	@interface DigitoVerificador {
		 ...
		 * @return Default message template string.
		 */
		String message() default "{com.creditas.clientes.validation.RFC.DigitoVerificador.message}";
