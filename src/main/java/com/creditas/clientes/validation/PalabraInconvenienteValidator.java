...
public class PalabraInconvenienteValidator implements ConstraintValidator<RFC.PalabraInconveniente, String> {
	...
	private static final String[] PALABRAS = new String[] { "BUEI", "BUEY", "CACA", "CACO", "CAGA", "CAGO", "CAKA",
			"COGE", "COJA", "COJE", "COJI", "COJO", "CULO", "FETO", "GUEY", "JOTO", "KACA", "KACO", "KAGA", "KAGO",
			"KAKA", "KOGE", "KOJO", "KULO", "MAME", "MAMO", "MEAR", "MEON", "MION", "MOCO", "MULA", "PEDA", "PEDO",
